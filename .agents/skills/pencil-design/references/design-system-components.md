...
- [design-to-code-workflow.md](design-to-code-workflow.md) — Map reusable components to project React primitives
- [tailwind-shadcn-mapping.md](tailwind-shadcn-mapping.md) — Tailwind and optional shadcn-style mapping table
