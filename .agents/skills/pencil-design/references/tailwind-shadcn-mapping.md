...
Quick-reference mapping from Pencil design properties to Tailwind v4 code. This file still includes optional shadcn-style component names as conceptual references, but TopProperties uses local React primitives unless a later decision adds shadcn/ui.
...
## Pencil Component -> Optional Component Mapping

| Pencil Component | Local/optional component | Key Classes |
|-----------------|-----------|-------------|
