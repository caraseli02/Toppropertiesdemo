...
- Stack/scaffold decisions stay blocked until the AI-composed UI spike and design pass produce outputs.
- Old SPA restoration requests should be treated as reference-migration tasks, not default implementation work.
- Scope-expansion requests outside Mallorca luxury homes should be parked unless the product direction changes.
