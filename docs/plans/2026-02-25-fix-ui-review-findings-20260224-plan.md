...
const openMapFromMenu = () => { setViewMode('map'); setPendingScrollTarget('map'); };
const openGridFromMenu = () => { setViewMode('grid'); setPendingScrollTarget('grid'); };
```
...
// ...
toast.success('Request received', { description: 'Sarah Anderson will contact you within 24 hours.' });
```
