...
const testimonials = [
  ...
  },
  {
    id: 4,
    quote:
      "Their local expertise in Dubai was invaluable. From understanding off-plan regulations to negotiating terms, the team handled everything with professionalism and speed.",
    author: "Raj Patel",
              ...
              {testimonials.map((_, i) => (
                <button
                  ...
                  className={`w-2 h-2 rounded-full transition-all duration-300 ${
                    i === current ? "bg-burgundy w-6" : "bg-border-light hover:bg-warm-gray"
                  }`}
                />
              ))}
            </div>
