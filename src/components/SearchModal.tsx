                ...
                {filteredProperties.map((property) => (
                  ...
                  >
                    <div className="flex gap-3 items-start">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-0.5">
                          {property.featured && (
                            <span className="bg-[var(--brand)] text-white px-1.5 py-0.5 rounded text-[10px] font-medium uppercase">
                              Featured
                            </span>
                          )}
                          {property.propertyType && (
                            <span className="text-[11px] text-gray-400 uppercase tracking-wide line-clamp-1 max-w-[120px] truncate">
                              {property.propertyType}
                            </span>
                          )}
                        </div>
                        <h4 className="font-semibold text-[15px] text-ink overflow-hidden text-ellipsis whitespace-nowrap">
                          {property.title}
                        </h4>
                        <p className="text-[13px] text-gray-500 overflow-hidden text-ellipsis whitespace-nowrap">
                          {property.location}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="mt-2 flex items-center justify-between gap-3">
                      <span className="font-bold text-[15px] leading-tight text-[var(--brand)] max-w-[58%] overflow-hidden text-ellipsis whitespace-nowrap">
                        {property.price}
                      </span>
