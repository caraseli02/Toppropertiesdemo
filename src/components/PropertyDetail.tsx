            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
              <div className="flex items-center justify-between">
                <Button
                  ...
                  className="gap-2 rounded-full h-11 px-3"
                >
                      ...
                      <div className="w-full h-full bg-white/10 flex items-center justify-center">
                        ...
                        >
                          <path
                            ...
                            strokeLinejoin="round"
                            strokeWidth={1.5}
                            d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l.932.932a2.25 2.25 0 003.182 0l5.159-5.159M3.75 21h16.5A2.25 2.25 0 0022.5 18.75V5.25A2.25 2.25 0 0020.25 3H3.75A2.25 2.25 0 001.5 5.25v13.5A2.25 2.25 0 003.75 21z"
                          />
                        </svg>
                      </div>
                    ) : (
